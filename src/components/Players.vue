              ...
              <div class="card-body row">
                ...
                <div class="col-md-8">
                  <h5 class="text-color-reverb mb-0 pb-0">
                    {{t.nick}}
                    <a v-if="t.instagram !== null && t.instagram !== undefined" :href="'https://www.instagram.com/' + t.instagram" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                    <a v-if="t.twitter !== null && t.twitter !== undefined" :href="'https://www.twitter.com/' + t.twitter" target="_blank"><i class="fa fa-twitter pl-2" aria-hidden="true"></i></a>
                  </h5>
